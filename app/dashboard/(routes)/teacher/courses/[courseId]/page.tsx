...
import { GradeDivisionForm } from "./_components/grade-division-form";
...
export default async function CourseIdPage({
    ...
    // Only owner (teacher) can view editor - teachers can only see their own courses
    if (user?.role === "TEACHER" && course.userId !== userId) {
